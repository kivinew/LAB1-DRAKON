...
void main()
{
	...
	while (c != '0')
	{
		cout << endl << "-------------------------ГЛАВНОЕ МЕНЮ-------------------------" << endl
		     << "1. Создать новый объект Время и вставить его в массив" << endl
		     << "2. Вывести значения всех объектов Время из массива" << endl
		     << "3. Изменить содержимое объекта Время с заданным номером" << endl
		     << "4. Удалить объект Время с заданным номером из массива" <<endl
		     << "5. Вызвать любой метод для объекта Время с заданным номером" << endl
		     << "0. Выход" << endl
		...
		switch (c)
		{
			case '1':
				...
				cout << endl << "----------Создание объекта Время и вставка его в массив----------" << endl
				     << "1. Создать новый объект Время по умолчанию" <<endl
				     << "2. Создать новый объект Время с вводом значений" << endl
				     << "3. Создать новый объект как копия из существующего объекта" << endl
				     << "Введите номер команды: ";
				cin >> c1;
			...
			case '5':
				...
				cout << "1. Вывести значение времени для выбранного объекта" <<endl
				     << "2. Сбросить значение времени для выбранного объекта" << endl
				     << "3. Изменить значение времени с вводом новых значений" << endl
				     << "4. Изменить значение времени как копию другого объекта" << endl
				     << "5. Прибавить указанное количество секунд к значению времени" << endl
				     << "6. Вывести количество созданных объектов Время" << endl
				     << "Введите номер команды: ";
				cin >> c1;
